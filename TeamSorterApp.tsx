        ...
        <div className="min-h-screen p-4 sm:p-6 lg:p-8">
            <div className="max-w-7xl mx-auto">
                <header className="text-center mb-10">
                    ...
                    <a href="#/" className="text-sm text-teal-400 hover:text-teal-300 mt-4 inline-block transition-colors">&larr; Voltar para a página inicial</a>
                </header>
